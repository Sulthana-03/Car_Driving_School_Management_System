          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="<?php echo base_url.'admin/?page=adminprofile' ?>"><span class="fa fa-user"></span> My Account</a>
...
?>
             ...
             <a href="logout.php?token=<?php echo $_SESSION['csrf_token'];?>" 
